...
export const ROUTE_IDS = {
  ...
  ageGroups: {
    ...
    lessonDates: "terminy-lekci",
    pricing: "cenik",
    pricingPro: "cenik-pro",
  },
  workshops: {
    page: "workshopy",
...
export const ROUTES = {
  ...
  ageGroups: {
    ...
    lessonDates: withHash(AGE_GROUPS, ROUTE_IDS.ageGroups.lessonDates),
    pricing: withHash(AGE_GROUPS, ROUTE_IDS.ageGroups.pricing),
    pricingPro: withHash(AGE_GROUPS, ROUTE_IDS.ageGroups.pricingPro),
  },
  workshops: {
    _: WORKSHOPS,
...
export const NAV_LINKS = {
  ...
  mobile: [
    ...
    { href: ROUTES.ageGroups.lessonDates, label: "Termíny lekcí", isNew: true },
  ...
  footer: [
    ...
    { href: ROUTES.ageGroups.lessonDates, label: "Termíny lekcí" },
